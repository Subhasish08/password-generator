...
useEffect(()=> {
  ...
  return (
    ...
    <div className=' w-full max-w-md mx-auto shadow-md rounded-lg px-5 py-3 my-8 text-orange-400 bg-slate-600 '>
    <h1 className=' text-white text-center text-2xl my-3 '>Password Generator</h1>
      <div className=' flex shadow rounded-lg  overflow-hidden mb-4'>
        <input className=' outline-none py-1   w-full px-3' value={password} type='text' placeholder='Password' 
        readOnly
        ref={passwordRef} />
